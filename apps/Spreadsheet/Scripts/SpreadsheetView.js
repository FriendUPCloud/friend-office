...
Application.fileName = 'Untitled.xlsx';
...
Application.receiveMessage = function( msg )
{
	...
	switch( msg.command )
	{
		...
		case 'insert_new_sheet': 
			if( Application.documentReady ) Application.addWorksheet();
			break;	
...
Application.addWorksheet = function()
{
	var editor = false;
	var ooi  = document.getElementById("oocontainer");
	...
	if( editor)
	{
		editor.postMessage('{"command":"add_worksheet"}','*');
	}
};
...
Application.onDownloadAs = function( evt )
{
	...
	m.onExecuted = function( e, d )
	{
		if( e == 'ok' )
		{
			...
			Notify( { title: i18n('i18n_spreadsheet'), text: i18n('i18n_spreadsheet_was_saved_prefix') + ' ' + fn + ' ' + i18n('i18n_spreadsheet_was_saved_suffix') } );
			Application.documentChanged = false;
...
Application.printFileServerSide = function()
{
	...
	var cdata = {
	    ...
	    "outputtype": "pdf",
	    "title": Application.documentInfo.original_name ? Application.documentInfo.original_name : 'New spreadsheet',
	    "url": Application.documentURL
	}
