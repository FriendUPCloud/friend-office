...
Application.fileName = 'Untitled.pptx';
...
Application.receiveMessage = function( msg )
{
	...
	switch( msg.command )
	{
		...
		case 'insert_slide':
			if( Application.documentReady ) Application.addSlide();
			break;						
...
Application.addSlide = function()
{
	...
	if( editor)
	{
		editor.postMessage('{"command":"add_slide"}','*');
	}
};
...
Application.onDownloadAs = function( evt )
{
	...
	m.onExecuted = function( e, d )
	{
		if( e == 'ok' )
		{
			...
			Notify( { title: i18n('i18n_presentation'), text: i18n('i18n_presentation_was_saved_prefix') + ' ' + fn + ' ' + i18n('i18n_presentation_was_saved_suffix') } );
			Application.documentChanged = false;
